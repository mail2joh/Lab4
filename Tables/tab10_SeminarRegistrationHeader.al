table 50110 "CSD Seminar Reg. Header"
{
    ...
    fields
    {
        field(1; "No."; Code[20])
        {
            ...
            begin
                if "No." <> xRec."No." then begin
                    SeminarSetup.Get;
                    NoSeriesMgt.TestManual(SeminarSetup."CSD Seminar Registration Nos.");
                    "No. Series" := '';
                end;
            end;
        }
        ...
        field(3; "Seminar No."; Code[20])
        {
            ...
            begin
                if "Seminar No." <> xRec."Seminar No." then begin
                    ...
                    Seminar.TestField("CSD Blocked", false);
                    Seminar.TestField("CSD Gen. Prod. Posting Group");
                    Seminar.TestField("CSD VAT Prod. Posting Group");
                    "Seminar Name" := Seminar."CSD Name";
                    Duration := Seminar."CSD Seminar Duration";
                    "Seminar Price" := Seminar."CSD Seminar Price";
                    "Gen. Prod. Posting Group" := Seminar."CSD Gen. Prod. Posting Group";
                    "VAT Prod. Posting Group" := Seminar."CSD VAT Prod. Posting Group";
                    "Minimum Participants" := Seminar."CSD Minimum Participants";
                    "Maximum Participants" := Seminar."CSD Maximum Participants";
                end;
            end;
        }
        ...
        {
            Caption = 'Comment';
            CalcFormula = Exist ("CSD Seminar Comment Line" where ("CSD Table Name" = const ("Seminar Registration"), "CSD No." = Field ("No.")));
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        field(27; "Posting No. Series"; Code[10])
        {
            ...
            begin
                with SeminarRegHeader do begin
                    ...
                    SeminarSetup.GET;
                    SeminarSetup.TestField("CSD Seminar Registration Nos.");
                    SeminarSetup.TestField("CSD Seminar Posting Nos.");
                    if NoSeriesMgt.LookupSeries(SeminarSetup."CSD Seminar Posting Nos.", "Posting No. Series")
                    then begin
            ...
            begin
                if "Posting No. Series" <> '' then begin
                    ...
                    SeminarSetup.TestField("CSD Seminar Registration Nos.");
                    SeminarSetup.TestField("CSD Seminar Posting Nos.");
                    NoSeriesMgt.TestSeries(SeminarSetup."CSD Seminar Posting Nos.", "Posting No. Series");
                end;
    ...
    begin
        ...
        SeminarCommentLine.SETRANGE("CSD Table Name", SeminarCommentLine."CSD Table Name"::"Seminar Registration");
        SeminarCommentLine.SETRANGE("CSD No.", "No.");
    ...
    begin
        if "No." = '' then begin
            SeminarSetup.GET;
            SeminarSetup.TestField("CSD Seminar Registration Nos.");
            NoSeriesMgt.InitSeries(SeminarSetup."CSD Seminar Registration Nos.", xRec."No. Series", 0D, "No.", "No. Series");
        end;

        IniRecord;
    end;

    local procedure IniRecord()
    ...
    begin
        ...
        SeminarSetup.GET;
        NoSeriesMgt.SetDefaultSeries("Posting No. Series", SeminarSetup."CSD Seminar Posting Nos.");
    end;
    ...
    begin
        with SeminarRegHeader do begin
            ...
            SeminarSetup.GET;
            SeminarSetup.TestField("CSD Seminar Registration Nos.");
            if NoSeriesMgt.SelectSeries(SeminarSetup."CSD Seminar Registration Nos.", OldSeminarRegHeader."No. Series", "No. Series") then begin
                SeminarSetup.GET;
                SeminarSetup.TestField("CSD Seminar Registration Nos.");
